...
### ● v1.11 — Minecraft 26.1.x compatibility update

**All artwork, design, and creative work in this pack remain the original author's.** This v1.11 fork only updates the technical metadata so the pack continues to load on **Minecraft Java Edition 26.1.x** 
— no textures, fonts, or UI elements have been redrawn, replaced, or reattributed.

**本资源包内所有美术、设计与创意素材仍归原作者所有。** 本 v1.11 分支仅修改技术兼容性，使资源包能在 **Minecraft Java 版 26.1.x** 上继续加载，未改动、替换或重新署名任何贴图、字体或界面元素。

**Changes in v1.11 / v1.11 更动内容**
...
- Pack assets remain under **GPL-3.0** (see `LICENSE.txt`).
- NotoSans / MCsans bitmaps remain under **OFL-1.1** (see `LICENSE_of_NotoSans.txt`).
- FluentEmoji bitmaps remain under **MIT** (see `LICENSE_of_FluentEmoji.txt`).

This fork inherits all three licenses unchanged. All credit for the pack itself goes to **零雾〇五 Fogg05**.  
本分支完全继承上述三项原始许可证。本资源包的全部署名权归原作者 **零雾〇五 Fogg05** 所有。

**Original author / 原作者:** 零雾〇五 Fogg05 — [Bilibili](https://space.bilibili.com/350715147)  
**Fork maintainer / 本分支维护者:** [@KaiC5504](https://github.com/KaiC5504)
